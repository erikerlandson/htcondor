...
BOOST_FIXTURE_TEST_CASE(cp_compute_1, cpfix) {
    ...
    BOOST_CHECK_EQUAL(consumption["cpus"], 2.0);
    BOOST_CHECK_EQUAL(consumption["memory"], 128.0);
    BOOST_CHECK_EQUAL(consumption["disk"], 1024.0);
    BOOST_CHECK_EQUAL(consumption["actuators"], 7.0);
}
...
BOOST_FIXTURE_TEST_CASE(cp_compute_2, cpfix) {
    ...
    BOOST_CHECK_EQUAL(consumption["memory"], 128.0);
    BOOST_CHECK_EQUAL(consumption["disk"], 1024.0);
    BOOST_CHECK_EQUAL(consumption["actuators"], 3.0);
...
BOOST_FIXTURE_TEST_CASE(cp_compute_3, cpfix) {
    ...
    BOOST_CHECK_EQUAL(consumption["memory"], 128.0);
    BOOST_CHECK_EQUAL(consumption["disk"], 1024.0);
    BOOST_CHECK_EQUAL(consumption["actuators"], 14.0);
...
BOOST_FIXTURE_TEST_CASE(cp_override_1, cpfix) {
    ...
    string attr;
    int v;
    formatstr(attr, "_orig_%s%s", ATTR_REQUEST_PREFIX, ATTR_CPUS);
    ...
    formatstr(attr, "_orig_%s%s", ATTR_REQUEST_PREFIX, ATTR_MEMORY);
    request.LookupInteger(attr.c_str(), v);
    BOOST_CHECK_EQUAL(v, 2);
    formatstr(attr, "%s%s", ATTR_REQUEST_PREFIX, ATTR_MEMORY);
    request.LookupInteger(attr.c_str(), v);
    ...
    formatstr(attr, "_orig_%s%s", ATTR_REQUEST_PREFIX, ATTR_DISK);
    request.LookupInteger(attr.c_str(), v);
    ...
    formatstr(attr, "_orig_%s%s", ATTR_REQUEST_PREFIX, "Actuators");
    request.LookupInteger(attr.c_str(), v);
    BOOST_CHECK_EQUAL(v, 4);
    formatstr(attr, "%s%s", ATTR_REQUEST_PREFIX, "Actuators");
    request.LookupInteger(attr.c_str(), v);
...
BOOST_FIXTURE_TEST_CASE(cp_deduct_1, cpfix) {
    ...
    BOOST_CHECK_EQUAL(cp_deduct_assets(request, resource), 2);
...
BOOST_FIXTURE_TEST_CASE(cp_deduct_2, cpfix) {
    ...
    BOOST_CHECK_EQUAL(cp_deduct_assets(request, resource), 7);
...
BOOST_FIXTURE_TEST_CASE(cp_deduct_3, cpfix) {
    ...
    resource.AssignExpr(ATTR_SLOT_WEIGHT, "Actuators");
    BOOST_CHECK_EQUAL(cp_deduct_assets(request, resource, true), 7);
